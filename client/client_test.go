...
func TestClient_getAllocatedResources(t *testing.T) {
	...
	testutil.WaitForResult(func() (bool, error) {
		...
		if as.ClientStatus != structs.AllocClientStatusPending {
		...
		if as.ClientStatus != structs.AllocClientStatusComplete {
		...
		if as.ClientStatus != structs.AllocClientStatusFailed {
